...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.createUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, cpf, isNew, newUser;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, name = _a.name, cpf = _a.cpf, isNew = _a.isNew;
                        newUser = new UserEntity_1.default(name, cpf, isNew);
                        return [4 /*yield*/, this.repository.createUser(newUser)];
                    case 1:
                        _b.sent();
    ...
    UserController.prototype.getUsers = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.getUsers()];
                    case 1:
                        users = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, this.repository.deleteUser(Number(id))];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, this.repository.updateUser(Number(id), req.body)];
                    case 1:
                        _a = _b.sent(), success = _a.success, message = _a.message;
                        if (!success) {
                            return [2 /*return*/, res.status(400).json({ message: message })];
