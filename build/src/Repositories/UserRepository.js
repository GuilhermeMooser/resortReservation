            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!userToDelete) {
                            return [2 /*return*/, { success: false, message: "The user does not exists" }];
                        }
                        return [4 /*yield*/, this.userRepository.remove(userToDelete)];
                    case 2:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, { success: true, message: "The user was successfully updated." }];
                    case 3:
                        e_2 = _a.sent();
                        console.log(e_2);
                        return [2 /*return*/, { success: false, message: "An error has occured." }];
                    case 4: return [2 /*return*/];
                }
            });
        });
